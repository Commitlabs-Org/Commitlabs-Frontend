...
- [x] Create branch `performance/next-font-self-host` and apply edits
...
- [x] Run `npm test` and `npm run lint` and confirm coverage thresholds (blocked in this environment due to PowerShell execution policy)
