...
the rules here are about _which_ metrics appear, in _what tier_, and with _what content_.
...
- `up` is not always good. Apply semantic direction: drawdown going _up_ is bad and renders
