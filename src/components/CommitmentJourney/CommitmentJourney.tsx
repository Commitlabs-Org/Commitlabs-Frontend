...
const FlameIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M8.5 14.5C8.5 14.5 10.5 12.5 10.5 10.5C10.5 8.5 8.5 6.5 8.5 6.5C8.5 6.5 6.5 8.5 6.5 10.5C6.5 12.5 8.5 14.5 8.5 14.5Z"
      fill="#F59E0B"
    />
    <path
      d="M12 2C12 2 12 6 9 8C6 10 5 13.5 6 16C7 18.5 9 22 12 22C15 22 18 19 18 16C18 13.5 17.5 10 15 8C12 6 12 2 12 2Z"
      stroke="#F59E0B"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
      ...
      <div className={styles.journeyContainer}>
            ...
            <div className={styles.cardsGrid}>
              ...
              <div className={styles.card}>
                ...
                <div className={styles.cardStats}>
                  ...
                  <div className={styles.statRow}>
                    ...
                    <span className={`${styles.yieldValue} ${styles.safeYield}`}>
                      Lower but stable
                    </span>
                  </div>
                </div>
              ...
              <div className={styles.card}>
                ...
                <div className={styles.cardStats}>
                  ...
                  <div className={styles.statRow}>
                    <span className={styles.yieldLabel}>Yield</span>
                    <span className={`${styles.yieldValue} ${styles.balancedYield}`}>
                      Medium yield
                    </span>
                  </div>
                </div>
              ...
              <div className={styles.card}>
                ...
                <div className={styles.cardStats}>
                  ...
                  <div className={styles.statRow}>
                    <span className={styles.yieldLabel}>Yield</span>
                    <span className={`${styles.yieldValue} ${styles.aggressiveYield}`}>
                      Maximum returns
                    </span>
                  </div>
                </div>
        ...
        <div className={styles.stepRow}>
          ...
          <div className={styles.stepContent}>
            ...
            <p className={styles.stepDescription}>
              Alice receives a unique Commitment NFT that represents her locked capital. The
              protocol allocates her funds dynamically within her defined rules, and commitment
              health is continuously attested on-chain.
            </p>
          </div>
        </div>
        ...
        <div className={styles.stepRow}>
          ...
          <div className={styles.stepContent}>
            ...
            <p className={styles.stepDescription}>
              The Commitment NFT can be reused as collateral or liquidity proof across other DeFi
              protocols, all while the original commitment remains active and enforced.
            </p>
          </div>
        </div>
        ...
        <div className={styles.stepRow}>
          ...
          <div className={styles.stepContent}>
            ...
            <p className={styles.stepDescription}>
              At maturity, funds are settled automatically and the NFT is archived on-chain as a
              permanent reliability record, building Alice&apos;s commitment history.
            </p>
          </div>
        </div>
      </div>
