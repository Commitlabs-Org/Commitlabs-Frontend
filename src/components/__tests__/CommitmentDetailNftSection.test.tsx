...
const renderNftSection = (overrides: Partial<typeof defaultProps> = {}) => {
  const props = {
    ...defaultProps,
    onCopyTokenId: vi.fn(),
    onCopyOwner: vi.fn(),
...
describe('CommitmentDetailNftSection', () => {
  ...
  it('renders token metadata with accessible copy and action controls', () => {
    ...
    expect(screen.getByRole('button', { name: 'Copy Contract Address' })).toBeTruthy();
    expect(screen.getByRole('button', { name: 'View NFT Details' })).toBeTruthy();
