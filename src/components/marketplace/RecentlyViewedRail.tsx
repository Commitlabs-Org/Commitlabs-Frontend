...
export function RecentlyViewedRail({
  ...
  return React.createElement(
    ...
    {
      className:
        'w-full mb-8 relative bg-gradient-to-r from-white/[0.02] to-transparent border border-white/5 rounded-2xl p-5',
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              'text-xs text-white/40 font-mono px-2 py-0.5 rounded-full bg-white/5 border border-white/5',
          },
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        {
          ...
          className:
            'flex gap-4 overflow-x-auto pb-2 pt-1 scroll-smooth snap-x snap-mandatory focus-ring',
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                {
                  className:
                    'grid grid-cols-2 gap-2 mt-1 border-t border-white/5 pt-2 text-[11px] w-full',
                },
                React.createElement(
                  'div',
                  null,
