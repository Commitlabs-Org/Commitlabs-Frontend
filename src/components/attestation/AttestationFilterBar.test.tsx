...
describe('AttestationFilterBar', () => {
  ...
  it('renders severity tabs with correct counts', () => {
    render(
      <AttestationFilterBar attestations={mockAttestations} onFilterChange={onFilterChange} />,
    );

    expect(
      screen.getByRole('tablist', { name: 'Filter attestations by severity' }),
    ).toBeInTheDocument();
  ...
  it('renders with empty attestations array', () => {
    render(<AttestationFilterBar attestations={[]} onFilterChange={onFilterChange} />);
  ...
  it('handles attestations with undefined severity', () => {
    const attestationsWithUndefined = [
      {
        id: '1',
        severity: undefined as AttestationSeverity | undefined,
        attestationType: 'health_check' as AttestationType,
      },
      {
        id: '2',
    ...
    const attestationsWithUndefined = [
      {
        id: '1',
        severity: 'ok' as AttestationSeverity,
        attestationType: undefined as AttestationType | undefined,
      },
      {
        id: '2',
        severity: 'ok' as AttestationSeverity,
  ...
  it('handles all-info history (only ok severity)', () => {
    ...
    render(
      <AttestationFilterBar attestations={allInfoAttestations} onFilterChange={onFilterChange} />,
    );
