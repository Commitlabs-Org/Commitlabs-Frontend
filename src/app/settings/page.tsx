...
import { ShieldAlert, Clock, Store, Info, Save, RotateCcw } from 'lucide-react';
      ...
      <div className="min-h-screen w-full bg-[#0a0a0a] text-white">
        <main id="main-content" className="mx-auto max-w-4xl px-4 pt-12 pb-24">
          ...
          >
            ...
            {isDirty && (
              <span className="ml-2 px-2 py-1 bg-yellow-500 text-black text-sm rounded">
                Unsaved changes
              </span>
            )}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 text-white/70 leading-relaxed max-w-2xl">
                <p>
                  CommitLabs respects your privacy. All notifications are processed using encrypted
                  on-chain data and secure off-chain indexing. We never share your notification
                  preferences or wallet activity with third parties.
                </p>
                <p className="text-sm">
                  Default settings are optimized for high-security environments. Critical security
                  alerts (Violations) cannot be fully disabled as they are essential for maintaining
                  protocol integrity.
                </p>
              </div>
            </div>
