  ...
  try {
    const success = spawnSync(bashPath, [scriptPath], {
      ...
      env: {
        ...
        COMMITLABS_FEE_RECIPIENT_ADDRESS:
          'GC3C4X5R7N2X7CII7SPRD4U6ZLKZKAJZDW6N4Q4QAV3FJ7Q3N7GJ5P6L',
    ...
    assert(
      writtenEnv.includes(
        'COMMITMENT_CORE_CONTRACT=CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABSC4',
      ),
