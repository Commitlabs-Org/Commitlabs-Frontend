...
describe('CreateCommitmentStepReview', () => {
  ...
  describe('Component Rendering', () => {
    ...
    it('displays commitment type correctly', () => {
      ...
      expect(screen.getByText('Your selected commitment strategy')).toBeInTheDocument();
    });
    ...
    it('renders the commitment type icon based on type label', () => {
      const { container } = render(<CreateCommitmentStepReview {...defaultProps} />);
  ...
  describe('Edit Button Rendering and Accessibility', () => {
    ...
    it('edit button for type section has correct aria-label', () => {
      ...
      expect(editButtons[0]).toHaveAttribute('aria-label', 'Edit commitment type');
    });
    ...
    it('edit button for amount section has correct aria-label', () => {
      ...
      const editButtons = screen.getAllByRole('button', { name: /Edit/ });
      expect(editButtons[1]).toHaveAttribute('aria-label', 'Edit commitment amount and asset');
    });
    ...
    it('edit button for duration section has correct aria-label', () => {
      ...
      const editButtons = screen.getAllByRole('button', { name: /Edit/ });
      expect(editButtons[2]).toHaveAttribute('aria-label', 'Edit commitment duration');
    });
    ...
    it('edit button for risk section has correct aria-label', () => {
      ...
      const editButtons = screen.getAllByRole('button', { name: /Edit/ });
      expect(editButtons[3]).toHaveAttribute('aria-label', 'Edit max loss and early exit settings');
    });
    ...
    it('edit buttons have descriptive titles', () => {
      ...
      expect(editButtons[0]).toHaveAttribute('title', 'Return to step 1 to edit commitment type');
      expect(editButtons[1]).toHaveAttribute('title', 'Return to step 2 to edit amount and asset');
      expect(editButtons[2]).toHaveAttribute('title', 'Return to step 2 to edit duration');
      expect(editButtons[3]).toHaveAttribute('title', 'Return to step 2 to edit risk parameters');
    });
  });
